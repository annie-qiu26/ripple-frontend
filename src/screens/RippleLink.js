        ...
        <ul>
          <li>
            <RippleStatCard
              ...
              description={"Total money raised using your link and all subsequent links"}
              field="raised"
            />
          </li>
          <li>
            <RippleStatCard
              ...
              description={"Total views of your link and all subsequent links"}
              field="views"
            />
          </li>
          <li>
            <RippleStatCard
              ...
              description={"Number of unique visitors who traveled to your link"}
          ...
          <li>
            <RippleStatCard
              ...
              description={"Number of subsequent links generated by your referral badge"}
              field="descendants"
            />
          </li>
          <li>
            <RippleStatCard
              ...
              description={"Farthest link created from this ripplit"}
              field="depth"
            />
          </li>
          <li>
            <RippleStatCard
              ...
              description={"Total number of miles traveled for all subequent link creation"}
              field="miles"
            />
          </li>
        </ul>
